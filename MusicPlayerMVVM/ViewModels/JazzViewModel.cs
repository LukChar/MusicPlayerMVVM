...
namespace MusicPlayerMVVM.ViewModels
{
    ...
    /// </summary>
    public class JazzViewModel : ViewModelBase
    {
        ...
        /// <summary>
        /// Initialisiert das JazzViewModel, konfiguriert Steuerungskommandos und abonniert Datenereignisse.
        /// </summary>
        /// <param name="eventAggregator">Die Instanz des Prism EventAggregators für systemweites Messaging.</param>
        public JazzViewModel(IEventAggregator eventAggregator) : base(eventAggregator)
        {
        ...
        private void LoadSongsFromDatabase()
        {
            try
            {
                ...
                {
                    con.Open();
                    string query = "SELECT * FROM Songs_Jazz";
