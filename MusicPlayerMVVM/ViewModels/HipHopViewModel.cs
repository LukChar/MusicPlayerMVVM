...
{
    public class HipHopViewModel : NotifyPropertyChanged
    {
        ...
        public HipHopViewModel(MainViewModel mainViewModel)
        {
        ...
        private void LoadSongsFromDatabase()
        {
            try
            {
                ...
                {
                    con.Open();
                    string query = "SELECT * FROM Songs_HipHop";
