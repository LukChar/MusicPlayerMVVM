    ...
    public class KlassikViewModel : ViewModelBase
    {
        ...
        private void LoadSongsFromDatabase()
        {
            try
            {
                ...
                {
                    // HIER KORRIGIERT: Greift jetzt auf KlassikSongs statt auf HipHopSongs zu
                    var klassikEntities = context.KlassikSongs.ToList();
                    foreach (var song in klassikEntities)
                    {
                        Songs.Add(song);
                    }
                }
